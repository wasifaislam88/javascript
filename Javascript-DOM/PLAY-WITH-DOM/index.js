...
uniquepara.style.backgroundColor = "green";
uniquepara.style.fontSize = "40px";
...
const myTags = document.getElementsByClassName("info"); 
...
const allClassEelements = document.getElementsByClassName("info");

for(const element of allClassEelements){

    // console.log("ha vai ami etai dekhte chisi",element);
...
// const nextSibling = item2.previousElementSibling;
...
//setattribute()||getAttribute()||removeAttributr()
...
/**
 * creating an element and append||add class name||classlist().remove()]||appernd child vs append ||remove child()
 */
